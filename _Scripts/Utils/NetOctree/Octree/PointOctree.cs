...
namespace Octree
{
    ...
    public partial class PointOctree<T>
    {
        ...
        // public ICollection<T> GetAllInOctant(int octant)
        // {
        //     List<T> objects = new List<T>(Count);
        //     _rootNode.GetAllInOctant(objects, octant);
        //     return objects;
        // }

        // public void Adjust(T obj, Vector3 objPos)
        // {
        //     // change node's position
        //     // if node is in a new octant, remove it from the old octant, add to the new octant
        //     _rootNode.Adjust(obj, objPos);
        // }
